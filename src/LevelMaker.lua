...
function LevelMaker.createMap(level)
    ...
    -- whether we want to generate a locked brick for this level
    local locked = math.random(1, 2) == 1 and true or false
    -- Randomise the position of the locked brick within the specified rows and columns for the level
    local locked_pos = {
        math.random(numRows),
        math.random(numCols)
    }
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            if (locked_pos[1] == y and locked_pos[2] == x) then
                b.color = 6
                b.tier = 3
                b.locked = true
